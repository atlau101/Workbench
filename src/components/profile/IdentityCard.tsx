  ...
  return (
    <Card className="p-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="font-heading text-[12px] font-semibold uppercase tracking-[0.08em] text-[var(--color-on-surface-variant)]">
            Identity
          </p>
          <h1 className="mt-3 font-heading text-[32px] font-semibold text-[var(--color-on-surface)]">
            {name}
          </h1>
