  ...
  return (
    <section className="flex min-h-0 flex-col gap-4">
      ...
      <div className="flex-1 overflow-y-auto space-y-4 pr-1">
        {responses.length === 0 ? (
          <SandboxArea className="p-5 shadow-sm">
          ...
          responses.map((response, index) => (
            <SandboxArea key={response.id} className="p-5 shadow-sm">
              <div className="flex items-center justify-between gap-3 mb-3">
                <span className="font-[Lexend] text-[12px] font-semibold tracking-[0.05em] uppercase text-[var(--color-primary)]">
                  Student Pre-Work
                </span>
